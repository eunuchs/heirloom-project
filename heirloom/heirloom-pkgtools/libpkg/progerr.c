...
/*	from OpenSolaris "progerr.c	1.13	06/02/27 SMI"	*/

/*
 * Portions Copyright (c) 2007 Gunnar Ritter, Freiburg i. Br., Germany
 *
 * Sccsid @(#)progerr.c	1.5 (gritter) 2/26/07
 */
...
static void 		(*fatal_err_func)(int) = &error_and_exit;
