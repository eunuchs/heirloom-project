...
/*	from OpenSolaris "doulimit.c	1.5	06/11/17 SMI"	*/

/*
 * Portions Copyright (c) 2007 Gunnar Ritter, Freiburg i. Br., Germany
 *
 * Sccsid @(#)doulimit.c	1.3 (gritter) 2/25/07
 */
...
void ulimit_quit(int);	/* XFSZ controlled signal handler. */
int clr_ulimit(void);	/* Clear the user supplied file size limit. */
void set_limit(void);	/* Called from installf to undo ulimit */
